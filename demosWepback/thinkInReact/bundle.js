	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('input', { type: 'checkbox', checked: this.props.inStockOnly ? 'checked' : '' })
	      )
	    );
	  }
	});
	...
	var FilterableProductTable = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(ProductTable, { rows: data, filterText: this.state.filterText, inStockOnly: this.state.inStockOnly })
	    );
	  }
	});

	ReactDOM.render(React.createElement(FilterableProductTable, { url: '/api/comments', timeout: '2000' }), document.getElementById('content'));
