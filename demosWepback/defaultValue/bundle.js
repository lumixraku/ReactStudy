...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form2 = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'select',
	      { name: '', id: '', value: this.state.helloTo, onChange: this.handleChange },
	      React.createElement(
	        'option',
	        { value: 'A' },
	        'A'
	...
	ReactDOM.render(React.createElement(Form2, null), document.getElementById('content'));
