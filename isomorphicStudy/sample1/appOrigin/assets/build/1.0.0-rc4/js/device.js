	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _reactRouter.Route,
	          { path: '/', component: this.wrapComponent(_LayoutView2.default) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeviceView = function (_Component) {
	  ...
	  function DeviceView() {
	    ...
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(DeviceView)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      text: ""
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'testevent' },
	          _react2.default.createElement('input', { type: 'text', onChange: this.changeContent }),
	          _react2.default.createElement(
	            'div',
	            { className: 'msg', ref: 'input' },
	            this.state.text
	          )
	        )
	      );
	...
	var ContentView = function (_Component) {
	  ...
	  (0, _createClass3.default)(ContentView, [{
	    ...
	    value: function getText(device) {
	      return 'this data is fetch from device of ' + device + '  !!contentview';
	    }
	  }, {
